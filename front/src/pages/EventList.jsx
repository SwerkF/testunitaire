    ...
    */
    return (
        ...
        <ul class= "event-container">
            <CardComponent title="Festival du Havre" description="description brève de l'évènement avec beacoup d'info" buttonText="plus d'info" imageUrl="https://img.freepik.com/photos-gratuite/lumiere-scene-rougeoyante-illumine-fans-rock-liesse-generes-par-ia_188544-37983.jpg" id="1"/>
